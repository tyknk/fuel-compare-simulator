...
自動車販売店の商談で使用する、HEV車（ハイブリッド）とガソリン車の燃料コスト比較Webアプリ。
タブレットまたはPCのブラウザで開き、スライダーでパラメータを変更しながら結果を表示する。
...
損益分岐年数が本アプリの主要な指標なので、4つのKPIの中で最も大きく表示する。
